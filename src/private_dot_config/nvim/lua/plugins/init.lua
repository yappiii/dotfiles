...
packer.startup(function(use)
  ...
  -- use({ "coder/claudecode.nvim", requires = { "folke/snacks.nvim" }, config = true, keys = {{ '<leader>cc', '<cmd>ClaudeCode<cr>', desc = "Toggle Claude" }} })
  ...
  use({ "nvim-lualine/lualine.nvim", requires = { "nvim-tree/nvim-web-devicons", opt = true }, config = function() require("plugins.config.lualine") end })
  ...
  use({ "nvimdev/dashboard-nvim", event="VimEnter", requires = { "nvim-tree/nvim-web-devicons" }, config = function() require("plugins.config.dashboard") end })
  ...
  use({ "stevearc/conform.nvim", config = function() require("plugins.config.conform") end })
